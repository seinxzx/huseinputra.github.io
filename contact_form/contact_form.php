...
$from = 'info@seinnn.com'; // Replace it with Your Hosting Admin email. REQUIRED!

$sendTo = 'huseinputrawp@gmail.com'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $secret = '6LfWtKQeAAAAAC2va9aQAedajXpcA53gvwT0NAEL';
